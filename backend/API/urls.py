from API.views import CreateUserView, ThreadDetailView, ThreadListCreateView, TopicCreateListView, TopicDetailView, UserDetailView, ListPostView
...
urlpatterns = [
    ...
    path('view_post/<int:pk>', ListPostView.as_view())
]
